...
// resulting in more bloated codegen, while on later versions it goes through s32.
...
struct SequencePlayer {
    ...
    /*0x034*/ struct SequenceChannel *channels[CHANNELS_MAX];
    /*0x074*/ struct M64ScriptState scriptState;
    /*0x090*/ u8 *shortNoteVelocityTable;
    /*0x094*/ u8 *shortNoteDurationTable;
    /*0x098*/ struct NotePool notePool;
    /*0x0D8*/ OSMesgQueue seqDmaMesgQueue;
    /*0x0F0*/ OSMesg seqDmaMesg;
    /*0x0F4*/ OSIoMesg seqDmaIoMesg;
    /*0x10C*/ OSMesgQueue bankDmaMesgQueue;
    /*0x124*/ OSMesg bankDmaMesg;
    /*0x128*/ OSIoMesg bankDmaIoMesg;
    /*0x140*/ u8 *bankDmaCurrMemAddr;
    /*0x144*/ uintptr_t bankDmaCurrDevAddr;
    /*0x148*/ ssize_t bankDmaRemaining;
}; // size = 0x14C
...
struct AdsrState {
    ...
    /*0x18*/ f32 target;
    s32 pad1C;
    /*0x20*/ struct AdsrEnvelope *envelope;
}; // size = 0x24
...
struct SequenceChannel {
    ...
    /*0x04*/ u8 reverbVol; // UQ0.8
    /*0x05*/ u8 notePriority; // 0-3
    /*0x06*/ u8 unkSH06; // some priority
    /*0x07*/ u8 bankId;
    /*0x08*/ u8 reverbIndex;
    /*0x09*/ u8 bookOffset;
    /*0x0A*/ u8 newPan;
    ...
    /*0x0E*/ u16 vibratoRateStart; // initially 0x800
    /*0x10*/ u16 vibratoExtentStart;
    /*0x12*/ u16 vibratoRateTarget; // initially 0x800
    /*0x14*/ u16 vibratoExtentTarget;
    /*0x16*/ u16 vibratoRateChangeDelay;
    /*0x18*/ u16 vibratoExtentChangeDelay;
    /*0x1A*/ u16 vibratoDelay;
    /*0x1C*/ u16 delay;
    /*0x1E*/ s16 instOrWave; // either 0 (none), instrument index + 1, or
    // 0x80..0x83 for sawtooth/triangle/sine/square waves.
    /*0x20*/ s16 transposition;
    /*0x24*/ f32 volumeScale;
    /*0x28*/ f32 volume;
    /*0x2C*/ s32 pan;
    /*0x30*/ f32 appliedVolume;
    /*0x34*/ f32 freqScale;
    /*0x38*/ u8 (*dynTable)[][2];
    /*0x3C*/ struct Note *noteUnused; // never read
    /*0x40*/ struct SequenceChannelLayer *layerUnused; // never read
    /*0x44*/ struct Instrument *instrument;
    /*0x48*/ struct SequencePlayer *seqPlayer;
    /*0x4C*/ struct SequenceChannelLayer *layers[LAYERS_MAX];
    /*0x64*/ struct M64ScriptState scriptState;
    /*0x80*/ struct AdsrSettings adsr;
    /*0x88*/ struct NotePool notePool;
...
struct SequenceChannelLayer {
    ...
    /*0x02*/ u8 instOrWave;
    /*0x03*/ u8 status; // 0x03 in SH
    /*0x04*/ u8 noteDuration; // set to 0x80
    /*0x05*/ u8 portamentoTargetNote;
    /*0x06*/ u8 pan; // 0..128
    /*0x07*/ u8 notePan;
    /*0x08*/ struct Portamento portamento;
    /*0x18*/ struct AdsrSettings adsr;
...
struct NoteSynthesisState {
    ...
    /*0x10*/ s16 curVolLeft; // Q1.15
    /*0x12*/ s16 curVolRight; // Q1.15
};
struct NotePlaybackState {
    ...
    /*0x10*/ struct SequenceChannelLayer *prevParentLayer;
    /*0x14*/ struct SequenceChannelLayer *parentLayer;
    /*0x18*/ struct SequenceChannelLayer *wantedParentLayer;
    /*0x1C*/ struct NoteAttributes attributes;
    /*0x2C*/ struct AdsrState adsr;
    /*0x4C*/ struct Portamento portamento;
    /*0x5C*/ struct VibratoState vibratoState;
};
struct NoteSubEu {
    ...
    /*0x05*/ u8 reverbVol; // Q1.7
    /*0x06*/ u16 targetVolLeft; // UQ0.10
    /*0x08*/ u16 targetVolRight; // UQ0.10
...
struct Note {
    ...
    /*0x33*/ u8 bankId;
    /*0x34*/ u8 unkSH34;
    /*0x36*/ s16 adsrVolScale;
    /*0x38*/ f32 portamentoFreqScale;
    /*0x3C*/ f32 vibratoFreqScale;
    /*0x40*/ struct SequenceChannelLayer *prevParentLayer;
    /*0x44*/ struct SequenceChannelLayer *parentLayer;
    /*0x48*/ struct SequenceChannelLayer *wantedParentLayer;
    /*0x4C*/ struct NoteAttributes attributes;
    /*0x5C*/ struct AdsrState adsr;
    /*0x80*/ struct Portamento portamento;
    /*0x90*/ struct VibratoState vibratoState;
    u8 pad3[8];
    /*0xB4*/ struct NoteSubEu noteSubEu;
}; // size = 0xC8
