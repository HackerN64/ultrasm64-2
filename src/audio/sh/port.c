...
struct SPTask *create_next_audio_frame_task(void) {
    ...
    osSendMesg(OSMesgQueue0, (OSMesg) gAudioFrameCount, OS_MESG_NOBLOCK);
    ...
    if (osRecvMesg(OSMesgQueue2, (OSMesg *) &sp38, OS_MESG_NOBLOCK) != -1) {
    ...
    if (gAudioResetStatus != 0) {
        if (audio_shut_down_and_reset_step() == 0) {
            if (gAudioResetStatus == 0) {
                osSendMesg(OSMesgQueue3, (OSMesg) (s32) gAudioResetPresetIdToLoad, OS_MESG_NOBLOCK);
            }
            D_SH_80314FCC = 0;
            return NULL;
        }
    ...
    if (osRecvMesg(OSMesgQueue1, (OSMesg *) &sp34, 0) != -1) {
        do {
            func_802ad7ec(sp34);
        } while (osRecvMesg(OSMesgQueue1, (OSMesg *) &sp34, 0) != -1);
    }
...
void port_eu_init_queues(void) {
    D_SH_80350F18 = 0;
    D_SH_80350F19 = 0;
    OSMesgQueue0 = &OSMesgQueue0Data;
    OSMesgQueue1 = &OSMesgQueue1Data;
    OSMesgQueue2 = &OSMesgQueue2Data;
    OSMesgQueue3 = &OSMesgQueue3Data;
    osCreateMesgQueue(OSMesgQueue0, OSMesg0, 1);
    osCreateMesgQueue(OSMesgQueue1, OSMesg1, 4);
    osCreateMesgQueue(OSMesgQueue2, OSMesg2, 1);
    osCreateMesgQueue(OSMesgQueue3, OSMesg3, 1);
}
...
void func_802ad7a0(void) {
    ...
    osSendMesg(OSMesgQueue1, (OSMesg)mesg, OS_MESG_NOBLOCK);
...
s32 func_sh_802f6900(void) {
    ...
    ret = osRecvMesg(OSMesgQueue3, (OSMesg *) &sp18, 0);
...
void func_sh_802f6958(OSMesg mesg) {
    ...
    do {
        a = -1;
    } while (osRecvMesg(OSMesgQueue3, &recvMesg, OS_MESG_NOBLOCK) != a);
    func_sh_802f6540();
    osSendMesg(OSMesgQueue2, mesg, OS_MESG_NOBLOCK);
}
