...
struct SPTask *create_next_audio_frame_task(void) {
    ...
    osSendMesg(OSMesgQueue0, (OSMesg) gAudioFrameCount, 0);
    ...
    if (osRecvMesg(OSMesgQueue2, &sp30, 0) != -1) {
    ...
    if (osRecvMesg(OSMesgQueue1, &sp2C, OS_MESG_NOBLOCK) != -1) {
