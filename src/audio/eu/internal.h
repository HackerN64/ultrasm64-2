...
struct SequencePlayer {
    ...
    /*0x030*/ struct SequenceChannel *channels[CHANNELS_MAX];
    /*0x070*/ struct M64ScriptState scriptState;
    /*0x08C*/ u8 *shortNoteVelocityTable;
    /*0x090*/ u8 *shortNoteDurationTable;
    /*0x094*/ struct NotePool notePool;
    /*0x0D4*/ OSMesgQueue seqDmaMesgQueue;
    /*0x0EC*/ OSMesg seqDmaMesg;
    /*0x0F0*/ OSIoMesg seqDmaIoMesg;
    /*0x108*/ OSMesgQueue bankDmaMesgQueue;
    /*0x120*/ OSMesg bankDmaMesg;
    /*0x124*/ OSIoMesg bankDmaIoMesg;
    /*0x13C*/ u8 *bankDmaCurrMemAddr;
    /*0x140*/ uintptr_t bankDmaCurrDevAddr;
    /*0x144*/ ssize_t bankDmaRemaining;
}; // size = 0x148
...
struct SequenceChannel {
    ...
    /*0x04*/ u8 reverbVol; // until EU: Q1.7, after EU: UQ0.8
    /*????*/ u8 notePriority; // 0-3
    /*0x06*/ u8 bankId;
    /*0x07*/ u8 reverbIndex;
    /*0x08*/ u8 bookOffset;
    ...
    /*0x40*/ struct Instrument *instrument;
    /*0x44*/ struct SequencePlayer *seqPlayer;
    /*0x48*/ struct SequenceChannelLayer *layers[LAYERS_MAX];
    /*0x58*/ s8 soundScriptIO[8]; // bridge between sound script and audio lib. For player 2,
    // [0] contains enabled, [4] contains sound ID, [5] contains reverb adjustment
    /*0x60*/ struct M64ScriptState scriptState;
    /*0x7C*/ struct AdsrSettings adsr;
    /*0x84*/ struct NotePool notePool;
}; // size = 0xC4
...
struct SequenceChannelLayer {
    ...
    /*0x48*/ struct AudioBankSound *sound;
    /*0x4C*/ struct SequenceChannel *seqChannel;
    /*0x50*/ struct M64ScriptState scriptState;
    /*0x6C*/ struct AudioListItem listItem;
    /*    */ u8 pad2[4];
}; // size = 0x80
...
struct Note {
    ...
    /*0x7C*/ struct Portamento portamento;
    /*0x8C*/ struct VibratoState vibratoState;
    /*    */ u8 pad3[8];
...
struct AudioSessionSettingsEU {
    ...
    /*0x18*/ u32 temporarySeqMem;
    /*0x1C*/ u32 temporaryBankMem;
}; // size = 0x20
